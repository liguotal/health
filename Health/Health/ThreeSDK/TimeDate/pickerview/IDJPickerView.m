...
- (void)_setSelectionArea {
    ...
    UIImageView * img = [[UIImageView alloc]initWithFrame:CGRectMake(0, selectionY, 320, rowHeight)];
    img.backgroundColor = [UIColor colorWithRed:147.0/255.0 green:168.0/255.0 blue:207.0/255.0 alpha:0.3];
    img.image = [UIImage imageNamed:@"date_selecte_bg"];
    [self addSubview:img];
//    //左侧
...
//    selectionLeftView.backgroundColor = [UIColor clearColor];
//    selectionLeftView.alpha=0.3;
...
//    selectionRightView.backgroundColor = [UIColor clearColor];
