...
+ (void)getUserData
{
    [User LMData].stringID=[LM_USER_DEFAULT objectForKey:@"stringID"];
    [User LMData].name= [LM_USER_DEFAULT objectForKey:@"name"];
    [User LMData].sex=[LM_USER_DEFAULT objectForKey:@"sex"];
    [User LMData].brithday=[LM_USER_DEFAULT objectForKey:@"brithday"];
    [User LMData].disease=[LM_USER_DEFAULT objectForKey:@"disease"];
    [User LMData].education=[LM_USER_DEFAULT objectForKey:@"education"];
    [User LMData].marriage=[LM_USER_DEFAULT objectForKey:@"marriage"];
    [User LMData].profession=[LM_USER_DEFAULT objectForKey:@"profession"];
    [User LMData].remark=[LM_USER_DEFAULT objectForKey:@"remark"];
    [User LMData].phone=[LM_USER_DEFAULT objectForKey:@"phone"];
}
//存储用户信息isAgreeProtol
+ (void)storeUserData
{
    [LM_USER_DEFAULT setObject:[User LMData].stringID forKey:@"stringID"];
    [LM_USER_DEFAULT setObject:[User LMData].name forKey:@"name"];
    [LM_USER_DEFAULT setObject:[User LMData].sex forKey:@"sex"];
    [LM_USER_DEFAULT setObject:[User LMData].brithday forKey:@"brithday"];
    [LM_USER_DEFAULT setObject:[User LMData].disease forKey:@"disease"];
    [LM_USER_DEFAULT setObject:[User LMData].education forKey:@"education"];
    [LM_USER_DEFAULT setObject:[User LMData].marriage forKey:@"marriage"];
    [LM_USER_DEFAULT setObject:[User LMData].profession forKey:@"profession"];
    [LM_USER_DEFAULT setObject:[User LMData].remark forKey:@"remark"];
    [LM_USER_DEFAULT setObject:[User LMData].phone forKey:@"phone"];
}
